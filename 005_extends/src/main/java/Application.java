...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(String.format("某天它先%s，在饥肠辘辘之际%s了一只%s，然后%s一顿，",
                eagles.fly(), eagles.hunt(), eagles.getPrey()[0], eagles.eat()));
        System.out.printf(String.format("心满意足之后就%s了。", eagles.sleep()));
    }
}
